...
#
# OUTDIR
#   Where the resulting library, libunwind.a, should be placed
#
# CPPFLAGS
...
#
# CXXPPFLAGS
#   Preprocessor options for C++; should generally include "-nostdinc++" and include path(s) for a
#   (suitable) C++ standard library.
#
# CFLAGS
...
#
# Eg values:
# CXXPPFLAGS=-nostdinc++ -I/some/dir/libunwind/include -isystem /some/dir/libbmcxx/include
